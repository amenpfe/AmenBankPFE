...
<section class="panel">
        <div class="panel-body">
            ...
            <div  style="margin-top: 25%; margin-bottom: 25%">
                <div class="col-sm-6">
                    <canvas id="chdProjCanvas"></canvas>
                </div>
                <div class="col-sm-6">
...
@section('page-scripts')
    ...
    <script>
        @php
            $rest = 100 - $chdProjPercentage;
        @endphp
        //ChdProjChart
        var chdProjCtx = document.getElementById('chdProjCanvas').getContext('2d');

        new Chart(chdProjCtx, {
            type: 'doughnut',
            data: {
