...
<li class="nav-parent">
    ...
    <li class="nav-parent">
        ...
        <ul class="nav nav-children">
            <li class="{{route('all_new_request_cai')}}">
                <a href="">
                    <i class="fa fa-plus" aria-hidden="true"></i>
                    Des nouveaux projets
                </a>
...
<section class="panel">
        <div class="panel-body">
            ...
            <div  style="margin-top: 25%; margin-bottom: 25%">
                <div class="col-sm-6">
                    <canvas id="caiProjCanvas"></canvas>
                </div>
                <div class="col-sm-6">
...
@section('page-scripts')
    ...
    <script>
        ...
        @endphp
        //caiProjChart
        var caiProjCtx = document.getElementById('caiProjCanvas').getContext('2d');

        new Chart(caiProjCtx, {
            type: 'doughnut',
            data: {
