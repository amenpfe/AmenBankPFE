...
<section class="panel">
        <div class="panel-body">
            ...
            <div  style="margin-top: 25%; margin-bottom: 25%">
                <div class="col-sm-6">
                    <canvas id="cdqProjCanvas"></canvas>
                </div>
                <div class="col-sm-6">
...
@section('page-scripts')
    ...
    <script>
        @php
            $rest = 100 - $cdqProjPercentage;
        @endphp
        //CdqProjChart
        var cdqProjCtx = document.getElementById('cdqProjCanvas').getContext('2d');

        new Chart(cdqProjCtx, {
            type: 'doughnut',
            data: {
